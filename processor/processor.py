...
def get_data(
    ...
    # Assume distance and calories functions are implemented elsewhere
...
def main():
    ...
    query = {
        "username": username,
        "date": {"$regex": f"\\d{{2}}/{ current_month }/{ current_year }"},
    }
    ...
    response = {"month": month_data, "week": week_data, "today": today_data}
    return response
